...
const WHATSAPP_NUMBER = "+34 684 73 17 62";
const WHATSAPP_NUMBER_CLEAN = "+34684731762";
const EMAIL = "admisionesnebula@gmail.com";
const EMAIL_URL = `mailto:${EMAIL}?subject=${encodeURIComponent("Solicitud de diagnóstico — Nebula")}`;
const INSTAGRAM_URL = "https://instagram.com/nebula.lambda";
...
function NebulaLogo({ className = "" }: { className?: string }) {
  return (
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              {[
                ...
                <li key={h}>
                  <a href={h} className="text-foreground/80 hover:text-foreground">
                    {l}
                  </a>
                </li>
              ))}
